...
- Two-branch flow: PRs target `dev`; `main` is stable and only moves by promoting `dev`.
  See [CONTRIBUTING.md](CONTRIBUTING.md). Solo maintainer work may branch off `dev` in place.
