...
// error; uniform (--decimate, the CLI's own default since 3.3) is the flat-rate
// algorithm, lower memory and better on uniformly-sized content. Splat Studio's own
// default stays 'adaptive' regardless of the CLI's default. Same value syntax either way.
