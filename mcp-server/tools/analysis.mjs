    ...
    server.registerTool('jobs', {
        ...
        try {
            ...
            for (;;) {
                ...
                if (job.status === 'cancelled') return failResult({ error: ERR.JOB_FAILED, message: `Job ${id} was cancelled.` });
